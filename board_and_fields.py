...
class Board:
    def __init__(self):
        self.board = [[Field(0, 0, figures.Rook('b')), Field(1, 0, figures.Knight('b')), Field(2, 0, figures.Bishop('b')), Field(3, 0, figures.Queen('b')), Field(4, 0, figures.King('b')), Field(5, 0, figures.Bishop('b')), Field(6, 0, figures.Knight('b')), Field(7, 0, figures.Rook('b'))],
